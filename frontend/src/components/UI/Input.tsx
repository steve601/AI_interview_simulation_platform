...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className="w-full space-y-1.5">
      ...
      <input
        id={inputId}
        className={`w-full bg-white border border-[#CBD5E1] rounded-sm px-3.5 py-2 text-sm text-[#0F172A] placeholder-[#94A3B8] focus:outline-none focus:ring-2 focus:ring-[#2563EB] focus:border-[#2563EB] transition-colors ${

...
class Routing:
    ...
    # this function receives the current state and returns the name of the next LangGraph node.
    @staticmethod
    def route_after_progress(state: Dict[str, Any]) -> str:
    ...
    @staticmethod
    def route_after_round_transition(state: Dict[str, Any]) -> str:
